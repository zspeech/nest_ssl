...
Based on NeMo's AccessMixin implementation
"""
...
_ACCESS_CFG: Dict[str, DictConfig] = {}
_ACCESS_ENABLED: Dict[str, bool] = {}
...
def set_access_cfg(cfg: DictConfig, model_guid: str):
    ...
    AccessMixin.update_access_cfg(cfg, guid=model_guid)
